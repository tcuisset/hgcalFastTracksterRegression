...
doTrainVal("babyDNN-ratioLoss-constrained1", model, optimizer, mkSched(optimizer, 10), loss=loss_constrained_v1, nepochs=30)
...
optimizer = torch.optim.AdamW(model.parameters())
doTrainVal("mediumDNN-ratioLoss-constrained1", model, optimizer, mkSched(optimizer), loss=loss_constrained_v1)
...
optimizer = torch.optim.AdamW(model.parameters())
doTrainVal("largeDNN-ratioLoss-constrained1", model, optimizer, mkSched(optimizer, 40), loss=loss_constrained_v1, nepochs=200)
